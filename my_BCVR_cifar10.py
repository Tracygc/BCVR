...
#  L ship/
#  L truck/
path_to_train = "G:datasets/cifar10/train/"
path_to_test = "G:datasets/cifar10/test/"


# The ResNet-18 backbone in this benchmark is slightly different from the torchvision variant
# as it starts with a 3x3 convolution and has no stride and no MaxPool2d.
# This is a typical variation used for CIFAR-10 benchmarks of SSL methods.
...
# dataset = LightlyDataset(path_to_train, transform=transform2)
...
for model, results in bench_results.items():
    ...
    print(
        f"| {model.decode('utf-8'):<13} | {batch_size:>10} | {max_epochs:>6} "
