...
class BCVRProjectionHead(ProjectionHead):
    """Prediction head used for BCVR.
    ...
    def __init__(
        ...
        super(BCVRProjectionHead, self).__init__(
            [
                (input_dim, hidden_dim,nn.ReLU(), nn.BatchNorm1d(hidden_dim) ),
                (hidden_dim, output_dim, None, None),
            ]
        )

class BCVRPredictionHead(ProjectionHead):
    """Prediction head used for BCVR.
    ...
    def __init__(
        ...
        super(BCVRPredictionHead, self).__init__(
            [
                (input_dim, hidden_dim,nn.ReLU(), nn.BatchNorm1d(hidden_dim) ),
                (hidden_dim, output_dim, None, None),
            ]
