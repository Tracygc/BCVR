...
parser.add_argument("--train-dir", type=Path, default="G:/datasets/Imagenet2012/Imagenet2012/ILSVRC2012_img_train")
parser.add_argument("--val-dir", type=Path, default="G:/datasets/Imagenet2012/Imagenet2012/ILSVRC2012_img_val")
...
parser.add_argument("--skip-knn-eval", action="store_true", default=False)
